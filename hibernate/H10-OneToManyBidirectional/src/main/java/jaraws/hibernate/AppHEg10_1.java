...
public class AppHEg10_1 
{
	...
	public static void main(String[] args) {
		...
		try {
			...
			ud.addVehicle(vc1); // Invoking the helper method
			
			// Creating an instance of Vehicle Entity type
			Vehicle vc2 = new Vehicle();
			vc2.setVehicleType("Car");
			ud.addVehicle(vc2); // Invoking the helper method
			
			// Creating an instance of Vehicle Entity type
			Vehicle vc3 = new Vehicle();
			vc3.setVehicleType("Bus");
			ud.addVehicle(vc3); // Invoking the helper method
