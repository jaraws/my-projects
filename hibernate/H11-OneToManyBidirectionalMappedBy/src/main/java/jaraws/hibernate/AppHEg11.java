...
public class AppHEg11 
{
	...
	public static void main(String[] args) {
		...
		try {
			...
			vc1.setUserDetail(ud);
			
			// Creating an instance of Vehicle Entity type
			Vehicle vc2 = new Vehicle();
			vc2.setVehicleType("Car");
			ud.getVehicle().add(vc2);
			vc2.setUserDetail(ud); // Adding User to Vehicle for bidirectional relationship
			
			// Creating an instance of Vehicle Entity type
			Vehicle vc3 = new Vehicle();
			vc3.setVehicleType("Bus");
			ud.getVehicle().add(vc3);
			vc3.setUserDetail(ud); // Adding User to Vehicle for bidirectional relationship
